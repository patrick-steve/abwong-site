        ...
        <div className="flex flex-col -mx-6">
          {NEWS.map((n, i) => (
            <div
              ...
              className="grid gap-12 items-center px-6 py-9 border-b border-[var(--border)] cursor-pointer transition-colors duration-200"
              style={{
            ...
            >
              ...
              <div
                className="w-10 h-10 border flex items-center justify-center font-[family-name:var(--font-inter)] text-[16px] shrink-0 transition-colors duration-200"
                style={{
